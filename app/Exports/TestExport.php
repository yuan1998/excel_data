...
class TestExport implements WithMultipleSheets
{
    ...
    public static $AccountHeaders = [
        ...
        '账户'   => '',
        '推广数据' => [
            '互动', '评论', '私信', '评论转出', '展现', '点击', '点击率', '点击成本', '消费（实）', '消费(虚)', '总表单', "有效表单", '空号', "未接通", '重复表单', '有效表单占比', "空号占比", '未接通占比', '重复表单占比', '转微', '总预约'
        ],
        '咨询数据' => [
            '总建档', '一级建档', '二级建档', '三级建档', '四级建档', '五级建档', '未建档', '新客到院', '二次到院', '老客到院',
            '新客首次到院率', '新客二次到院率', '老客到院率'
        ],
        '院内数据' => [
            '首次成交', '二次成交', "老客成交", '总成交', '首次业绩', '二次业绩', '老客业绩', '总业绩', "首次单体", "二次单体", "老客单体", '总单体', '首次成交占比', '二次成交占比', '老客成交占比', '首次成交率', '二次成交率', '老客成交率', '总成交率', '首次业绩占比', '二次业绩占比', '老客业绩占比'
        ],
        '价值数据' => [
            "表单成本", "有效表单成本", "转微成本", "预约成本", "到诊成本", "到诊(首次)成本", "新客投产", "总投产"
        ],
    ];
    ...
    public static $BaseHeaders = [
        ...
        '推广数据' => [
            ...
            "未接通", '重复表单', '未下预约单', '有效表单占比', "空号占比", '未接通占比', '重复表单占比', '转微', '总预约'
        ],
        '咨询数据' => [
            '建档', '未建档', '新客到院', '二次到院', '老客到院', '新客首次到院率', '新客二次到院率', '老客到院率'
        ],
        '院内数据' => [
            '首次成交', '二次成交', "老客成交", '总成交', '首次业绩', '二次业绩', '老客业绩', '总业绩', "首次单体", "二次单体", "老客单体", '总单体', '首次成交占比', '二次成交占比', '老客成交占比', '首次成交率', '二次成交率', '老客成交率', '总成交率', '首次业绩占比', '二次业绩占比', '老客业绩占比'
        ],
    ...
    public static $ChannelHeaders = [
        ...
        '推广数据' => [
            '展现', '点击', '点击率', '点击成本', '消费（实）', '消费(虚)', '总表单', "有效表单", '空号',
            "未接通", '重复表单', '未下预约单', '有效表单占比', "空号占比", '未接通占比',
            '重复表单占比',
            '转微', '总预约'
        ],
        '咨询数据' => [
